"""
Django settings for baakiapp project.
...
SECRET_KEY = 'django-insecure-d5^5t0^11rbk6r#r(bt)0yekhw+fadg4*1wpvcn@r_7*ot*&vc'
...
WSGI_APPLICATION = 'baakiapp.wsgi.application'
